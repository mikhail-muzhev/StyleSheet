...
Pod::Spec.new do |spec|
  ...
  # spec.homepage     = "http://EXAMPLE/StyleSheet"
  ...
  # Or just: spec.author    = "Mikhail Muzhev"
  # spec.authors            = { "Mikhail Muzhev" => "mikhail.muzhev@ltst.ru" }
  # spec.social_media_url   = "https://twitter.com/Mikhail Muzhev"
